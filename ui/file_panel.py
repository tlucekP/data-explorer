...
def _update_scan_signature(
    root_path: str,
    selected_types: list[str],
    search: str,
    size_range: tuple[int, int] | None,
    modified_range: tuple[datetime, datetime] | None,
) -> None:
    scan_signature = (
        root_path,
...
def _resolve_selected_file(entries: list[dict[str, Any]]) -> str:
...
def render_file_panel(root_path: str, search: str) -> str:
    ...
    with st.container(key="file_panel_shell"):
        ...
        selected_types = _resolve_selected_types()
        size_range = _resolve_size_range()
        modified_range = _resolve_modified_range()
        _update_scan_signature(root_path, selected_types, search, size_range, modified_range)
        ...
        selected_file = _resolve_selected_file(entries)
